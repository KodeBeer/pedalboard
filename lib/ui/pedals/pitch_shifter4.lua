...
local PitchShifterPedal4 = Pedal:new()
-- Must match this pedal's .sc file's *id
PitchShifterPedal4.id = "pitchshifter4"
...
PitchShifterPedal4.peak_cpu = 1

local SEMITONE = math.pow(2, 1/12)
local CENT = math.pow(2, 1/1200)

function PitchShifterPedal4:new(bypass_by_default)
...
function PitchShifterPedal4:name(short)
  return short and "PITCH4" or "Pitch Shifter4"
end

function PitchShifterPedal4.params()
  local id_prefix = PitchShifterPedal4.id
...
function PitchShifterPedal4._calculate_freq_mul(interval, just_intonation, fine)
  local mul_pre_fine
...
function PitchShifterPedal4:_message_engine_for_param_change(param_id, value)

...
local PitchShifterPedal3 = Pedal:new()
-- Must match this pedal's .sc file's *id
PitchShifterPedal3.id = "pitchshifter3"
...
PitchShifterPedal3.peak_cpu = 1

local SEMITONE = math.pow(2, 1/12)
local CENT = math.pow(2, 1/1200)

function PitchShifterPedal3:new(bypass_by_default)
...
function PitchShifterPedal3:name(short)
  return short and "PITCH3" or "Pitch Shifter3"
end

function PitchShifterPedal3.params()
  local id_prefix = PitchShifterPedal3.id
...
function PitchShifterPedal3._calculate_freq_mul(interval, just_intonation, fine)
  local mul_pre_fine
...
function PitchShifterPedal3:_message_engine_for_param_change(param_id, value)

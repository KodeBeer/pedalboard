...
local PitchShifterPedal2 = Pedal:new()
-- Must match this pedal's .sc file's *id
PitchShifterPedal2.id = "pitchshifter2"
...
PitchShifterPedal2.peak_cpu = 1

local SEMITONE = math.pow(2, 1/12)
local CENT = math.pow(2, 1/1200)

function PitchShifterPedal2:new(bypass_by_default)
...
function PitchShifterPedal2:name(short)
  return short and "PITCH2" or "Pitch Shifter2"
end

function PitchShifterPedal2.params()
  local id_prefix = PitchShifterPedal2.id
...
function PitchShifterPedal2._calculate_freq_mul(interval, just_intonation, fine)
  local mul_pre_fine
...
function PitchShifterPedal2:_message_engine_for_param_change(param_id, value)
